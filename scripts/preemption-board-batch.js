 ...
 * 회당 요청 상한.
 *
 * [2026-08-18 상향] 사장님 지시: "100개를 채웠으면 좋겠는데". 실측 산수 —
 * 이번 회차 180콜 → 검증 91 → 통과 36(40%). 통과 100행이려면 검증 ~250,
 * 즉 ~520콜이 필요하다. 월 환산 주2회 × 520 ≈ 4,500콜로 무료 총한도
 * 5,000 안이고, 수동 회차가 겹쳐 넘치면 유료 $3/1,000 — 월 몇천 원 수준.
 * 회차를 굶기는 것보다 싸다.
 */
const DEFAULT_MAX_PER_RUN = 520;

/**
 * 주제당 채우고 싶은 개수.
 * 확실한 층부터 채우고 모자라면 아래 층을 깐다 — 빈손으로 끝내지 않기 위해서다.
 * [2026-08-18] 5 → 8: 보드 100행 목표(32주제 × 통과율 감안).
 */
const DEFAULT_TARGET_PER_TOPIC = 8;
