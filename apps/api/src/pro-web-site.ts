  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .mindmap-root {
      ...
      background: linear-gradient(135deg, rgba(14,165,233,.18), rgba(53,211,153,.08));
      color: var(--gold);
      font-weight: 1000;
    }
    ...
    @media (max-width: 820px) {
      .metrics, .workbench, .lookup-row, .golden-stats, .ops-grid, .tool-tabs, .tool-form, .tool-detail-grid, .catalog-strip, .catalog-list, .download-grid, .settings-grid, .settings-checklist, .admin-ai-provider-grid, .admin-content-tools, .api-issue-grid, .mindmap-view, .mindmap-branches { grid-template-columns: 1fr; }
