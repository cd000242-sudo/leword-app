...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .dialog label { display: block; margin: 10px 0 6px; font-size: 13px; color: var(--text-2); font-weight: 900; }
    ...
    .login-modal {
      z-index: 120;
      background:
        radial-gradient(620px 360px at 50% 18%, rgba(22,163,74,.18), transparent 62%),
        rgba(10,20,14,.76);
    }
    .pro-login-dialog {
      position: relative;
