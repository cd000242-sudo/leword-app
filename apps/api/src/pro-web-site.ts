  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .public-preview-mode #goldenNotice {
      border-color: rgba(248,194,27,.32);
    ...
    .grade.S { background: linear-gradient(135deg, var(--gold), #ffe66d); color: #052016; }
    ...
    .publish-decision.conditional strong { background: rgba(248,194,27,.16); color: #ffe58a; border: 1px solid rgba(248,194,27,.32); }
    ...
    .admin-ai-panel { margin-top: 14px; border-color: rgba(245,197,66,.36); background: linear-gradient(180deg, #FFFFFF, var(--surface-2)); }
    ...
    .settings-check.partial { border-color: rgba(245,197,66,.48); background: rgba(245,197,66,.08); }
