...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .golden-list { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 14px; }
    .golden-row {
      display: flex;
    ...
    .golden-row:hover { transform: translateY(-3px); box-shadow: var(--shadow); border-color: var(--green); }
