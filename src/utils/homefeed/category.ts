...
const CATEGORY_RULES: ReadonlyArray<{ category: HomefeedCategory; re: RegExp }> = [
   ...
   */
  { category: 'sports', re: /(야구|축구|농구|배구|골프|선수|감독|경기(?!도)|우승|준우승|리그|올림픽|월드컵|국가대표|홈런|선발\s?제외|명단\s?제외|압승|완승|쾌승|역전승|참패|완패|연승|연패|강등|승격|이적|영입|맞대결|해트트릭|멀티골|완봉|세이브|타율|승점|코리아컵|\bKBO\b|\bEPL\b|\bMLB\b|\bML\b|\bSON\b|토트넘|전북현대|키움|\bNC\b)/giu },
