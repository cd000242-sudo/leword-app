...
export const BLOGGER_CATEGORIES: BloggerCategoryInfo[] = [
  ...
  { id: 'policy',          label: '지원금/정책/복지',  icon: '🏦', affinityPattern: /(지원금|보조금|장려금|바우처|급여|수당|환급|감면|정책|복지|신청|대상|자격|서류|고용|청년|소상공인|자영업|육아휴직|출산지원|주거급여|기초연금|근로장려금|자녀장려금|에너지바우처|국민취업지원|정부24)/,
    description: '정부 지원금 정책 복지 보조금 장려금 바우처 급여 수당 환급 신청 대상 자격 서류 청년 소상공인 육아 출산 주거 고용 공식정보' },
  ...
  { id: 'celeb',           label: '스타/연예 이슈',    icon: '🌟', affinityPattern: /(스타|연예인|아이돌|배우|가수|걸그룹|보이그룹|컴백|신곡|앨범|뮤직비디오|티저|쇼케이스|콘서트|팬미팅|열애|결별|결혼|이혼|임신|출산|입대|전역|복귀|소속사|전속계약|시상식|공항패션|인스타|근황|출연|캐스팅)/,
    description: '스타 연예인 아이돌 배우 가수 컴백 신곡 앨범 뮤직비디오 콘서트 팬미팅 열애 결혼 복귀 소속사 시상식 방송 출연 근황' },
