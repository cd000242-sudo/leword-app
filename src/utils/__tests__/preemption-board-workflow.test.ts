...
describe('선점 보드 워크플로 — 실행 시각', () => {
    ...
    /*
     * 2026-09-09 에 주 1회·4,000 으로 줄였다가 2026-09-11 되돌렸다.
     * 줄인 채로 두면 보드가 최대 7일 낡는다 — 실측 2026-09-11 금요일에 발행본이 52시간짜리였고,
     * 그 사이 무료 맛보기 다섯 중 넷이 보드에서 사라져 방문자가 카드를 한 장만 봤다.
     *
     * 상한도 같이 올려야 한다. 안 올리면 이름만 주 2회다 — 실측 장부가 이미 golden 6,284 라
     * 4,000 상한에서는 이번 달에 한 콜도 더 못 쓴다.
     *
     * 비용(실측 장부 2026-09-01~11): golden 6,284 · briefs 853 · issue 238 = 7,375콜 → 유료 $3.56.
     * 이 속도로 다음 달: 주 2회면 13,295콜 → 유료 $12.44. 한도 "20달러"(2026-09-07) 안이다.
     */
    it('황금 BD 는 달 11,000·회차 1,200 으로 묶인다 — 주 2회 × 1,200 × 4.3주 ≈ 10,320 이 이론 최대다', () => {
