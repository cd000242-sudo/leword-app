...
const CATEGORY_BUILTIN_SEEDS: Record<string, string[]> = {
    ...
    // 💎 36 카테고리 — 디테일 롱테일 (수식어 4개+ 골든존, v2.37.0)
    // 원칙: 헤드 명사 단독은 빅도메인 독점 영역 → 수식어 (대상/속성/시기/금액/방법) 4개+로 신생 진입 가능 골든존
    // 검색량 100~3000 구간 + 5~7토큰 + 구체 조건
    subsidy: [
        '청년월세지원 신청 자격 소득 기준 2026', '근로장려금 신청 기간 5월 자격 조건',
        '에너지바우처 신청 방법 동절기 하절기 차이', '소상공인 지원금 자격 매출 기준 신청',
        '청년도약계좌 가입 조건 소득 기준 정리', '한부모가정지원금 신청 자격 소득 기준',
        '아이돌봄서비스 신청 방법 정부 지원 비율', '내일배움카드 신청 자격 발급 후기',
        '실업급여 신청 자격 1년 미만 정리', '국민취업지원제도 1유형 2유형 차이',
        '문화누리카드 발급 자격 사용처 정리', '청년 전세대출 자격 소득 기준 정리',
        '청년내일저축계좌 가입 조건 자격 정리', '농민기본소득 신청 자격 지급액 정리',
        '기초생활수급 자격 소득 재산 기준 정리', '출산지원금 지자체별 비교 정리',
        '양육수당 신청 방법 소득 기준 정리', '한부모가정 자격 인정 기준 정리',
    ],
    loan: [
        '주담대 갈아타기 시기 금리 비교 2026', '청년 전세대출 한도 조건 신청 후기',
        '햇살론 youth 자격 소득 기준 후기', '신용대출 갈아타기 금리 비교 정리',
        '전세대출 한도 계산 방법 소득 기준', '대환대출 신청 시기 절약 후기',
    ],
    finance: [
        '연말정산 의료비 공제 한도 5만원 절약', '월급쟁이 5천만원 모으기 식단 절약',
        '청년도약계좌 vs 청년희망적금 차이 정리', '연금저축 세액공제 한도 16.5% 정리',
        '적금 금리 비교 5% 우대 조건 정리', '연말정산 신용카드 vs 체크카드 공제',
    ],
    insurance: [
        '실손보험 4세대 vs 3세대 비교 정리', '자동차보험 다이렉트 비교 견적 후기',
        '운전자보험 가입 시기 보장 비교 정리', '태아보험 가입 시기 임신 몇주 정리',
        '암보험 갱신형 vs 비갱신형 차이 정리', '실손보험 청구 방법 1만원 환급 후기',
    ],
    realestate: [
        '아파트 청약 가점 84점 만들기 정리', '청약통장 1순위 자격 소득 기준',
        '신혼부부 특별공급 자격 소득 기준 정리', '생애최초 특별공급 자격 신청 정리',
        '재건축 분양가 상한제 적용 시기 정리', '오피스텔 투자 vs 아파트 차이 정리',
    ],
    legal: [
        '협의이혼 절차 비용 자녀 양육비 정리', '재산상속 포기 신청 절차 기간 정리',
        '근로계약서 미작성 신고 방법 후기', '전세계약서 작성 주의사항 정리 가이드',
    ],
    tax: [
        '종합소득세 5월 신고 방법 프리랜서 정리', '부가세 1기 확정신고 기간 방법',
        '양도세 1주택 비과세 요건 보유기간', '증여세 자녀 5천만원 면제 한도 정리',
        '연말정산 의료비 공제 영수증 5만원 환급', '상속세 5억 면제 한도 신고 정리',
    ],
    medical: [
        '국민건강검진 무료 항목 40대 정리', '의료비 환급 청구 방법 1만원 후기',
        '건강보험 본인부담금 환급 신청 정리', '국가건강검진 일반 vs 암검진 차이',
    ],
    dental: [
        '치과 스케일링 보험 적용 1년 1회 후기', '치아 검진 무료 1년 1회 신청 방법',
        '치과 진료비 환급 신청 방법 정리', '치아 보험 보장 범위 비교 정리',
    ],
    health: [
        '환절기 면역력 영양제 추천 직장인 30대', '5월 환절기 알레르기 비염 음식 정리',
        '40대 건강검진 항목 무료 정리 가이드', '혈압 130 80 관리 식단 1주일 정리',
        '단백질 1일 권장량 직장인 30대 식단', '환절기 비염 코막힘 1주일 해결 방법',
    ],
    supplement: [
        '40대 직장인 영양제 추천 가성비 비교', '오메가3 EPA DHA 함량 비교 가성비',
        '유산균 1세대 2세대 차이 추천 가성비', '비타민D 4000IU 추천 가성비 비교',
        '루테인 황반변성 예방 함량 비교 정리', '콜라겐 저분자 펩타이드 추천 비교',
    ],
    diet: [
        '직장인 1주일 다이어트 식단 5kg 후기', '간헐적단식 16:8 1주일 후기 식단',
        '저탄고지 1주일 식단 메뉴 후기 정리', '단백질 식단 1일 권장량 30대 후기',
    ],
    it: [
        '엑셀 VLOOKUP 함수 활용 1분 정리', '윈도우11 단축키 직장인 활용 정리',
        'AI 챗봇 ChatGPT 활용 직장인 후기', '아이패드 직장인 활용법 5가지 정리',
    ],
    laptop: [
        '100만원대 가성비 노트북 추천 비교 정리', '맥북 에어 M2 vs M3 차이 후기',
        '게이밍 노트북 200만원대 추천 비교', '대학생 가성비 노트북 추천 100만원',
    ],
    smartphone: [
        '아이폰 배터리 90% 유지 1년 활용 후기', '갤럭시 카메라 활용법 5가지 정리',
        '에어팟 프로 2 vs 1 차이 후기 정리', '스마트워치 갤럭시 vs 애플 비교',
    ],
    appliance: [
        '로봇청소기 100만원 이하 추천 비교', '건조기 6kg vs 9kg 차이 가성비',
        '에어컨 셀프 청소 1년 1회 방법 정리', '공기청정기 30평대 추천 비교 가성비',
        '식기세척기 6인용 vs 12인용 차이', '제습기 원룸 1평당 용량 정리',
    ],
    app: [
        '가계부 앱 직장인 30대 추천 비교', '운동 앱 홈트 무료 추천 비교',
        '독서 앱 무료 추천 직장인 비교', '영어공부 앱 직장인 30분 추천',
    ],
    education: [
        '초등 1학년 인강 추천 비교 후기', '중학 수학 인강 1등급 추천 비교',
        '고등 수능 인강 1년 추천 비교', '5살 7살 어린이 책 추천 정리',
    ],
    certificate: [
        '컴활 1급 1개월 합격 후기 정리', '토익 700점에서 900점 1개월 후기',
        '공무원 9급 1년 합격 공부법 후기', '한국사 능력검정 1급 1개월 합격',
        '운전면허 필기 1주일 합격 후기 정리', '직장인 자격증 추천 가성비 정리',
    ],
    business: [
        '스마트스토어 1개월 매출 100만원 후기', '카페 창업 비용 5천만원 정리',
        '소상공인 지원금 1차 2차 차이 정리', '프리랜서 종합소득세 5월 신고 후기',
        '부업 추천 직장인 월 50만원 후기', '사업자등록 신청 절차 1주일 후기',
    ],
    job: [
        '신입 자기소개서 1500자 합격 정리', '경력 면접 1차 2차 차이 후기',
        '연봉 협상 1000만원 인상 후기 정리', '직장인 이직 1년 차 후기 정리',
        '신입 이력서 양식 합격 정리 가이드', '경력 단절 여성 재취업 후기 정리',
    ],
    living: [
        '주방 수납 다이소 5천원 정리 꿀팁', '욕실 곰팡이 제거 락스 1주일 후기',
        '거실 인테리어 5만원 셀프 꿀팁 정리', '재택근무 책상 30만원 추천 비교',
        '신혼 가전 1500만원 추천 리스트 정리', '원룸 정리 5분 미니멀 꿀팁',
        '커피머신 식초 청소 1주일 후기 정리', '가습기 식초 청소 1주일 후기',
        '책상 정리 1주일 미니멀 꿀팁 정리', '옷장 정리 다이소 5천원 꿀팁',
    ],
    life_tips: [
        '욕실 곰팡이 락스 1주일 제거 후기', '주방 기름 때 베이킹소다 후기',
        '흰옷 누런 얼룩 과탄산소다 1주일', '와이셔츠 깃 때 베이킹소다 후기',
        '청소기 필터 1년 청소 방법 후기', '가스비 50% 절약 1개월 후기 정리',
    ],
    interior: [
        '5만원 거실 인테리어 셀프 꿀팁 후기', '원룸 5평 셀프 인테리어 후기',
        '신혼 30평 인테리어 1500만원 후기', '거실 조명 5만원 추천 비교 정리',
        '벽지 셀프 도배 1주일 후기 정리', '소형 침실 5평 인테리어 꿀팁',
    ],
    diy: [
        '셀프 도배 1주일 5만원 후기 정리', '셀프 페인팅 5만원 1주일 후기',
        '조립가구 1시간 30만원 추천 비교', '셀프 수리 1만원 5분 꿀팁 정리',
    ],
    gardening: [
        '베란다 가드닝 5천원 초보 시작 후기', '몬스테라 1년 키우는 방법 후기',
        '다육이 1년 키우기 5천원 후기 정리', '베란다 텃밭 1평 작물 추천 정리',
        '실내 식물 5천원 추천 비교 정리', '화분 분갈이 1년 1회 방법 후기',
    ],
    parenting: [
        '신생아 100일 수면교육 1주일 후기', '아기 6개월 이유식 1주일 메뉴',
        '아기 첫돌 음식 추천 1주일 메뉴', '유모차 30만원 가성비 추천 비교',
        '카시트 1세 5세 차이 추천 비교', '아이 4살 7살 한자 공부 방법',
        '5살 7살 책 추천 1년 정리 가이드', '아이 감기 1주일 회복 식단 후기',
    ],
    wedding: [
        '스드메 300만원 가성비 후기 정리', '신혼여행 1주일 가성비 추천 비교',
        '청첩장 디자인 5만원 셀프 후기', '예단 1500만원 준비 1주일 후기',
        '신혼 가전 1500만원 추천 비교 정리', '신혼 30평 인테리어 1500만원 후기',
    ],
    pet: [
        '소형견 슬개골 영양제 추천 가성비 비교', '강아지 분리불안 1주일 해결 후기',
        '강아지 1살 사료 추천 가성비 비교', '고양이 분리불안 1주일 해결 후기',
        '고양이 1살 사료 추천 가성비 비교', '강아지 산책 1일 적정 시간 정리',
        '고양이 모래 1개월 비교 가성비', '반려동물 보험 1년 비교 가성비',
    ],
    travel: [
        '제주도 3박4일 가족 코스 1인 30만원', '강원도 1박2일 드라이브 코스 정리',
        '서울 근교 당일치기 가성비 코스', '경상도 2박3일 가족 여행 코스',
        '국내 펜션 5만원대 추천 비교 정리', '주말 1박2일 가성비 여행 코스',
    ],
    car: [
        '엔진오일 1만km 교체 시기 정리', '타이어 4만km 교체 시기 정리',
        '블랙박스 30만원 추천 비교 가성비', '자동차 보험 다이렉트 견적 후기',
        '연비 좋은 1500cc 자동차 추천 비교', '자동차 셀프 세차 1주일 후기',
    ],
    beauty: [
        '30대 자외선 차단제 민감성 추천 비교', '30대 에센스 추천 비교 가성비',
        '쿠션 30대 가성비 추천 비교 정리', '립스틱 30대 컬러 추천 비교',
        '클렌징 1단계 2단계 차이 후기', '30대 메이크업 1주일 후기 정리',
    ],
    fashion: [
        '30대 봄 옷 코디 직장인 추천', '30대 초여름 청바지 코디 비교',
        '결혼식 5월 하객룩 30대 추천', '30대 환절기 옷 코디 1주일 정리',
        '30대 오피스 룩 1주일 코디 정리', '30대 데일리 룩 1주일 코디 정리',
    ],
    recipe: [
        '4인 가족 1주일 김치찌개 정리', '4인 가족 1주일 된장찌개 정리',
        '4인 가족 1주일 제육볶음 메뉴', '아기 6개월 이유식 계란찜 후기',
        '집밥 1주일 4인 가족 메뉴 정리', '5월 두릅 1주일 요리 메뉴',
    ],
    food: [
        '직장인 점심 1주일 도시락 메뉴', '집밥 1시간 저녁 메뉴 1주일',
        '집들이 1시간 음식 4인 메뉴', '회사 1주일 도시락 4인 메뉴',
        '주말 30분 한끼 1주일 메뉴', '5월 두릅 1주일 제철 메뉴',
    ],
    cooking: [
        '4인 가족 1주일 집밥 메뉴 정리', '주말 30분 1주일 요리 메뉴',
        '직장인 1주일 도시락 메뉴 정리', '아기 6개월 1주일 간식 메뉴',
    ],
    game: [
        'PS5 30대 추천 게임 1주일 후기', '닌텐도 스위치 가족 게임 1주일',
        '모바일 게임 직장인 30분 추천 비교', '스팀 1만원대 게임 추천 비교',
    ],
    sports: [
        '30대 요가 초보 1주일 자세 후기', '필라테스 30대 1개월 후기 정리',
        '러닝 초보 1주일 5km 후기 정리', '헬스 초보 1개월 루틴 후기',
        '홈트 30대 1주일 루틴 후기 정리', '30대 운동 초보 1주일 루틴',
    ],
    hobby: [
        '캠핑 1주일 준비물 4인 가족 정리', '캠핑장 1박2일 가성비 추천 비교',
        '카메라 100만원대 입문 추천 비교', '낚시 1만원대 입문 1주일 후기',
        '30대 직장인 1주일 책 추천 정리', '주말 드라이브 1박2일 코스 추천',
    ],
    review: [
        '100만원대 가성비 노트북 1년 후기', '50만원대 가성비 청소기 1년 후기',
        '30만원대 가성비 의자 1년 후기', '50만원대 가성비 매트리스 1년 후기',
    ],
    shopping: [
        '다이소 5천원 1주일 추천 정리', '쿠팡 핫딜 1주일 추천 비교',
        '직구 1주일 방법 1만원 후기', '편의점 신상 1주일 추천 비교',
    ],
    all: [
        '직장인 점심 1주일 도시락 메뉴', '4인 가족 1주일 집밥 메뉴 정리',
        '5만원 거실 인테리어 셀프 후기', '주방 수납 다이소 5천원 정리',
        '환절기 면역력 영양제 30대 추천', '5월 환절기 알레르기 비염 1주일',
    ],
};
