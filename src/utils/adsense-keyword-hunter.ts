...
const CATEGORY_BUILTIN_SEEDS: Record<string, string[]> = {
    ...
    // 💎 36 카테고리 — 모두 4토큰+ 검증 통과 롱테일로 정화 (v2.36.0)
    // 단일 명사 시드는 자동완성 입력용이지만 결과로 그대로 통과 시 가치 검증 Kill 발생
    // 모든 시드는 must-pass(검색량+경쟁+의도+글감+인물+YMYL) 통과 보증
    subsidy: [
        '근로장려금 자격 조건 신청 방법', '자녀장려금 신청 기간 자격',
        '청년내일저축계좌 조건 신청 방법', '청년도약계좌 가입 조건 정리',
        '청년월세지원 신청 방법 가이드', '소상공인지원금 신청 방법 정리',
        '소상공인새출발기금 자격 조건', '에너지바우처 신청 기간 가이드',
        '기초생활수급자 자격 조건 정리', '한부모가정지원금 신청 방법',
        '출산지원금 신청 방법 정리', '양육수당 자격 조건 신청',
        '아이돌봄서비스 이용 방법 가이드', '국민취업지원제도 신청 자격',
        '내일배움카드 사용 방법 가이드', '실업급여 신청 방법 정리',
        '농민기본소득 자격 조건 신청', '문화누리카드 사용 방법',
    ],
    loan: [
        '주담대 금리 비교 정리 2026', '신용대출 한도 조건 정리',
        '전세대출 신청 조건 비교', '대환대출 시기 비교 방법',
        '햇살론 자격 조건 신청 방법', '청년 전세대출 조건 정리',
    ],
    finance: [
        '연말정산 환급 방법 정리 가이드', '연말정산 신용카드 공제 한도',
        '월급 재테크 시작 방법 가이드', '청년도약계좌 가입 조건 정리',
        '연금저축 세액공제 한도 정리', '적금 금리 비교 추천 방법',
    ],
    insurance: [
        '실손보험 비교 가입 방법 정리', '자동차보험 비교 견적 방법',
        '암보험 비교 추천 가입 가이드', '운전자보험 가입 조건 비교',
        '태아보험 가입 시기 비교', '종신보험 vs 정기보험 차이',
    ],
    realestate: [
        '아파트 청약 가점 계산 방법', '청약통장 가입 방법 정리',
        '재건축 분양 신청 조건 정리', '전세 월세 차이 비교 가이드',
        '오피스텔 투자 시기 비교 정리', '갭투자 시작 방법 가이드',
    ],
    legal: [
        '이혼 조정 절차 신청 방법', '상속 포기 신청 방법 정리',
        '계약서 작성 방법 가이드 정리', '합의 조정 절차 정리',
    ],
    tax: [
        '종합소득세 신고 방법 정리', '부가세 신고 기간 방법 가이드',
        '양도세 계산 방법 정리 가이드', '증여세 면제 한도 정리',
        '상속세 신고 방법 정리 가이드', '연말정산 환급 방법 정리',
    ],
    medical: [
        '건강검진 종류 비교 정리 가이드', '국민건강보험 환급 신청 방법',
        '병원 진료비 환급 조건 정리', '의료보험 청구 방법 가이드',
    ],
    dental: [
        '치과 정기검진 시기 비교 가이드', '스케일링 보험 적용 조건',
        '임플란트 가격 비교 가이드 정리', '교정 종류 비교 방법 가이드',
    ],
    health: [
        '환절기 면역력 음식 추천 가이드', '건강검진 종류 비교 정리',
        '혈압 관리 방법 정리 가이드', '혈당 관리 식단 추천 방법',
        '단백질 보충제 비교 추천 가이드', '환절기 비염 코막힘 해결 방법',
    ],
    supplement: [
        '영양제 추천 비교 가이드 정리', '비타민D 추천 비교 효능 정리',
        '유산균 추천 비교 가이드 효능', '오메가3 추천 비교 효능 가이드',
        '루테인 추천 비교 효능 정리', '콜라겐 추천 비교 가이드 효능',
    ],
    diet: [
        '초여름 다이어트 식단 1주일 정리', '간헐적단식 시작 방법 가이드',
        '저탄고지 식단 추천 방법 정리', '단백질 식단 추천 가이드',
    ],
    it: [
        '아이패드 활용법 정리 추천 가이드', '엑셀 함수 활용 방법 정리',
        '윈도우11 단축키 활용 방법', 'AI 챗봇 활용 방법 가이드',
    ],
    laptop: [
        '노트북 발열 해결 방법 가이드', '맥북 활용법 정리 추천',
        '게이밍 노트북 추천 비교 가이드', 'LG그램 vs 갤럭시북 비교',
    ],
    smartphone: [
        '아이폰 배터리 절약 꿀팁 정리', '갤럭시 활용법 정리 가이드',
        '에어팟 활용법 정리 추천 가이드', '스마트워치 추천 비교 가이드',
    ],
    appliance: [
        '로봇청소기 추천 비교 가이드', '건조기 추천 비교 가성비 정리',
        '에어컨 청소 방법 가이드 정리', '공기청정기 추천 비교 가이드',
        '식기세척기 추천 비교 가성비', '제습기 추천 비교 방법 가이드',
    ],
    app: [
        '가계부 앱 추천 비교 가이드', '운동 앱 추천 비교 가이드',
        '독서 앱 추천 비교 가이드 정리', '영어공부 앱 추천 비교',
    ],
    education: [
        '초등 인강 추천 비교 가이드', '중학 인강 추천 비교 가이드',
        '고등 인강 추천 비교 가이드', '독서 추천 도서 정리 가이드',
    ],
    certificate: [
        '자격증 추천 가성비 정리 가이드', '컴활 1급 합격 방법 정리',
        '토익 점수 올리는 방법 정리', '공무원 시험 준비 방법 정리',
        '한국사 능력검정 합격 방법', '운전면허 필기 합격 방법 정리',
    ],
    business: [
        '소상공인 지원금 신청 방법 정리', '사업자등록 방법 가이드 정리',
        '스마트스토어 시작 방법 가이드', '부업 추천 비교 가이드 정리',
        '프리랜서 세금 신고 방법', '카페 창업 비용 정리 가이드',
    ],
    job: [
        '자기소개서 쓰는법 가이드 정리', '면접 후기 정리 추천 가이드',
        '연봉 협상 방법 가이드 정리', '이력서 쓰는법 추천 가이드',
        '경력 이직 시기 비교 정리', '취업 준비 방법 정리 가이드',
    ],
    living: [
        '주방 수납 정리 다이소 활용 가이드', '거실 인테리어 셀프 꿀팁 5만원',
        '욕실 곰팡이 제거 꿀팁 다이소', '베란다 가드닝 초보 시작 가이드',
        '집 정리 5분 꿀팁 미니멀', '주방 도구 추천 1인 가구 필수',
        '커피머신 청소 꿀팁 식초 활용', '가습기 청소 방법 식초 정리',
        '책상 정리 꿀팁 재택근무 활용', '옷장 정리 꿀팁 다이소 활용',
    ],
    life_tips: [
        '욕실 곰팡이 제거 꿀팁 정리', '주방 곰팡이 제거 꿀팁 가이드',
        '얼룩 제거 방법 가이드 정리', '세탁 꿀팁 정리 가이드 추천',
        '청소 꿀팁 정리 가이드 추천', '절약 꿀팁 정리 가이드 추천',
    ],
    interior: [
        '거실 인테리어 셀프 꿀팁 5만원', '소형 침실 인테리어 꿀팁 가이드',
        '원룸 인테리어 추천 비교 가이드', '신혼 인테리어 추천 가이드',
        '거실 조명 추천 비교 가이드 정리', '벽지 추천 비교 가이드 셀프',
    ],
    diy: [
        '셀프 도배 방법 가이드 정리', '셀프 페인팅 방법 가이드 정리',
        '조립가구 추천 비교 가이드 정리', '셀프 수리 방법 가이드 정리',
    ],
    gardening: [
        '베란다 가드닝 초보 시작 가이드', '몬스테라 키우는 방법 가이드',
        '다육이 키우는 방법 가이드 정리', '베란다 텃밭 작물 추천 초보',
        '실내 식물 추천 비교 가이드', '화분 분갈이 방법 가이드 정리',
    ],
    parenting: [
        '신생아 수면교육 방법 정리 가이드', '아기 이유식 시작 시기 정리',
        '아기 이유식 메뉴 추천 가이드', '유모차 추천 비교 가이드 정리',
        '카시트 추천 비교 가이드 정리', '아이 감기 빨리 낫는 방법',
        '아이 한자 공부 방법 가이드', '아이 책 추천 연령별 가이드',
    ],
    wedding: [
        '스드메 추천 비교 가이드 정리', '신혼여행 추천 비교 가이드',
        '청첩장 디자인 추천 가이드', '예단 예물 준비 방법 가이드',
        '신혼 가전 추천 리스트 필수', '신혼 인테리어 추천 가이드',
    ],
    pet: [
        '강아지 사료 비교 추천 가이드', '강아지 산책 시간 적절 가이드',
        '강아지 분리불안 해결 방법', '고양이 사료 추천 비교 가이드',
        '고양이 분리불안 해결 방법', '반려동물 보험 비교 추천 가이드',
    ],
    travel: [
        '국내 여행 코스 추천 가이드 정리', '제주도 여행 3박4일 코스',
        '주말 가성비 여행 코스 추천', '가족 여행 코스 추천 가이드',
        '드라이브 코스 추천 수도권 가이드', '국내 펜션 추천 비교 가이드',
    ],
    car: [
        '자동차 관리 방법 가이드 정리', '엔진오일 교체 시기 정리 가이드',
        '타이어 교체 시기 정리 가이드', '블랙박스 추천 비교 가이드',
        '자동차 보험 비교 견적 방법', '연비 좋은 자동차 추천 비교',
    ],
    beauty: [
        '봄 메이크업 가이드 추천 정리', '초여름 자외선 차단제 추천 민감성',
        '클렌징 방법 가이드 정리 추천', '에센스 추천 비교 가이드 정리',
        '쿠션 추천 비교 가이드 가성비', '립스틱 추천 비교 가이드 컬러',
    ],
    fashion: [
        '봄 옷 코디 추천 여성 가이드', '초여름 청바지 코디 여성',
        '5월 결혼식 하객룩 추천 여성', '환절기 옷 코디 가이드 정리',
        '오피스 룩 추천 비교 가이드', '데일리 룩 추천 비교 가이드',
    ],
    recipe: [
        '김치찌개 만드는법 정리 가이드', '된장찌개 만드는법 정리 가이드',
        '제육볶음 만드는법 정리 가이드', '계란찜 만드는법 정리 가이드',
        '집밥 1주일 메뉴 추천 4인 가족', '5월 제철 음식 두릅 요리 방법',
    ],
    food: [
        '점심 메뉴 추천 직장인 도시락', '저녁 메뉴 추천 집밥 1시간',
        '집들이 음식 추천 1시간 완성', '회사 점심 도시락 1주일 메뉴',
        '주말 한끼 요리 30분 완성', '5월 제철 음식 두릅 요리 방법',
    ],
    cooking: [
        '집밥 1주일 메뉴 추천 가이드', '주말 한끼 요리 30분 완성',
        '도시락 메뉴 추천 1주일 정리', '간식 만들기 추천 가이드 정리',
    ],
    game: [
        'PS5 추천 게임 비교 가이드', '닌텐도 스위치 추천 게임 비교',
        '모바일 게임 추천 비교 가이드', '스팀 추천 게임 비교 가이드',
    ],
    sports: [
        '요가 초보 자세 가이드 정리', '필라테스 시작 방법 가이드',
        '러닝 초보 시작 방법 가이드', '헬스 초보 루틴 가이드 정리',
        '홈트레이닝 추천 루틴 가이드', '운동 초보 루틴 가이드 정리',
    ],
    hobby: [
        '캠핑 준비물 체크리스트 가이드', '캠핑장 추천 비교 가이드',
        '카메라 추천 비교 입문 가이드', '낚시 입문 가이드 정리',
        '독서 추천 도서 정리 가이드', '드라이브 코스 추천 수도권',
    ],
    review: [
        '가성비 노트북 추천 비교 가이드', '가성비 청소기 추천 비교 가이드',
        '가성비 의자 추천 비교 가이드', '가성비 매트리스 추천 비교',
    ],
    shopping: [
        '다이소 추천 가성비 정리 가이드', '쿠팡 핫딜 추천 가이드',
        '직구 방법 가이드 정리 추천', '편의점 신상 추천 비교 가이드',
    ],
    all: [
        '점심 메뉴 추천 직장인 도시락', '집밥 1주일 메뉴 추천 가이드',
        '거실 인테리어 셀프 꿀팁 5만원', '주방 수납 정리 다이소 활용',
        '환절기 면역력 음식 추천 가이드', '5월 환절기 알레르기 코막힘 해결',
    ],
};
