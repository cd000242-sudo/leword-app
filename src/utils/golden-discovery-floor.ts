...
const FAST_ISSUE_INTENT_RE = /(뜻|의미|근황|공식입장|해명|입장문|결말|몇부작|출연진|방송시간|재방송|중계|하이라이트|라인업|예매|티켓팅|등급컷|답지|정답|발표|신청|조회|마감|일정|개봉일|출시일|오픈|변경|업데이트|사전예약|개막전|올스타전|월드컵|프로야구|KBO)/i;
