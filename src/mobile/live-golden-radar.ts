...
const SEARCHAD_BROAD_POLICY_BASE_RE = /(?:\uC2E4\uC5C5\uAE09\uC5EC|\uAD6D\uBBFC\uB0B4\uC77C\uBC30\uC6C0\uCE74\uB4DC|\uB0B4\uC77C\uBC30\uC6C0\uCE74\uB4DC|\uAD6D\uBBFC\uD589\uBCF5\uCE74\uB4DC|\uCCAD\uB144\uBBF8\uB798\uC801\uAE08|\uCCAD\uB144\uB3C4\uC57D\uACC4\uC88C|\uADFC\uB85C\uC7A5\uB824\uAE08|\uC790\uB140\uC7A5\uB824\uAE08|\uC5D0\uB108\uC9C0\uBC14\uC6B0\uCC98|\uBB38\uD654\uB204\uB9AC\uCE74\uB4DC|\uD3C9\uC0DD\uAD50\uC721\uBC14\uC6B0\uCC98|\uC18C\uC0C1\uACF5\uC778(?:\uC815\uCC45\uC790\uAE08|\uD3D0\uC5C5\uC9C0\uC6D0\uAE08|\uC9C0\uC6D0\uAE08|\uC9C0\uC6D0|\uB300\uCD9C)?)/u;
const SEARCHAD_BROAD_POLICY_GENERIC_INTENT_RE = /(?:\uC2E0\uCCAD\s*(?:\uBC29\uBC95|\uB300\uC0C1)|\uC790\uACA9\s*\uC870\uAC74|\uC9C0\uAE09\uC77C\s*\uC870\uD68C|\uC0AC\uC6A9\uCC98\s*\uC870\uD68C|\uC18C\uB4DD\uAE30\uC900)$/u;
...
function isBroadGenericPolicySearchAdProbe(keyword: string): boolean {
  ...
  if (ALLOWED_POLICY_AUDIENCE_NEED_RE.test(clean)) return false;
...
function writerReadySssProbePriorityScore(keyword: string, categoryId: string): number {
  ...
  const category = inferLiveCategory(clean, categoryId || 'all');
  if (LIVE_PROMOTION_LOW_VALUE_CATEGORIES.has(category)) return -260;
