...
const POLICY_AUDIENCE_COMPATIBLE_ANCHOR_RE = /(?:근로장려금|자녀장려금|실업급여|구직활동|고용보험|소상공인|정책자금|직접대출|대리대출|청년미래적금|청년도약계좌|기초연금|부모급여|아동수당|출산지원금|첫만남이용권|에너지바우처|문화누리|평생교육바우처|농식품바우처|기저귀바우처|주거급여|장애인|유공자|민생회복지원금|상생페이백)/u;
...
function hasSyntheticPolicyAudienceMismatch(keyword: string): boolean {
  ...
  return !POLICY_AUDIENCE_COMPATIBLE_ANCHOR_RE.test(clean);
}
